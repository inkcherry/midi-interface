...
multitrack = Multitrack(beat_resolution=4, name='example')
merged_multirack=get_merged(multitrack)
tracks=merged_multirack.tracks
# merged = multitrack[category_list['Piano']].get_merged_pianoroll()
k=[]
for key in tracks:
    print(key)
    print(merged_multirack.tracks[key])


# print(tf.shape(merged_multirack.tracks))
...
# save_midis(pr_re,"/home/liumingzhi/projectfile/midi-interface/5.mid")
#
# print("fsdfa")
# #test code    one track
